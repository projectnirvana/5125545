...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.one.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.one.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.one.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.two.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.two.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.two.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.three.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.three.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.three.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.four.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.four.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.four.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.five.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
                await self.five.join_chat("𝐊𝐚𝐫𝐦𝐚 𝐍𝐞𝐭𝐰𝐨𝐫𝐤.......✨😱")
